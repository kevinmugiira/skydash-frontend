...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{asset('assets/images/podcast logo2.png')}}" />
</head>
<body>
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="{{url('dashboard')}}"><img src="{{asset('assets/images/logo-no-background.svg')}}" class="mr-2" alt="logo"/></a>
...
<script src="{{asset('assets/js/vendors/chart.js/Chart.min.js')}}"></script>
<script src="{{asset('assets/js/vendors/datatables.net/jquery.dataTables.js')}}"></script>
<script src="{{asset('assets/js/vendors/datatables.net-bs4/dataTables.bootstrap4.js')}}"></script>
